...
/*A partir de ese vector me retorne los nombres de los pokemon */
...
//fachada la cual se llama igual que el mismo método quel metodo que quiero
//exportar con el sufijo FACHADA
const obtenerPokemonsFachada = async (longitud) => {
    return await obtenerPokemons(longitud)
}
//Método simple Defaul para exportar un solo método
